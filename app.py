...
def render_home():
    st.markdown("""
    <div class="hero">
        <div class="hero-title">Aditya Creative Studio</div>
        <div class="hero-subtitle">We craft cinematic digital experiences.</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="section">
        <p class="about-text">
        We are a modern creative studio blending cinematic storytelling, intelligent systems, and refined design to build unforgettable digital experiences.
        </p>
    </div>
    """, unsafe_allow_html=True)
    cols = st.columns(3)
    ...
    for col, feature in zip(cols, features):
        with col:
            st.markdown(f"""
            <div class="card">
                <div class="card-title">{feature[0]}</div>
                <div class="card-desc">{feature[1]}</div>
            </div>
            """, unsafe_allow_html=True)
...
def render_about():
    ...
    <div class="section">
        ...
        We merge creativity with technology to craft premium digital experiences that elevate brands and inspire audiences.
        </p>
        <div class="section-divider"></div>
        <p class="about-text">
        Our vision is to redefine digital storytelling through cinematic design, emotional engagement, and future-ready AI solutions.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
def render_footer():
    st.markdown("""
    <div class="footer">
        <div class="footer-brand">Aditya Creative Studio</div>
        <div>© 2026 Aditya Creative Studio. All rights reserved.</div>
        <div>Instagram • LinkedIn • YouTube</div>
    </div>
    """, unsafe_allow_html=True)
